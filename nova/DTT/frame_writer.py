...
writer = FFMpegWriter(fps=2, bitrate=1000)
...
def animate(index): 
    ...
    pl.plot(-2,-14,'o',alpha=0)
    pl.plot(22,15,'o',alpha=0)
    ...
    index ==inv.log['position_iter'][-1]-1:
        ...
        plasma = False
    inv.eq.pf.plot(coils=inv.eq.pf.coil,label=True,plasma=plasma,current=True) 
